...
let bytes bytes_string = b'ab\0cde\0f\0g'
...
let unicode unicode_string = u'abc\0defg\u1234\uF8D2'
...
let unicode klingon_character = u'\uF8D2'
...
let unicode wide_unicode_character = u'\U0010FEDC'
