...
def test_reduce(vector[i32] v, int init):
    """
    Test reduce.
     0 + 1 = 1
     1 + 2 = 3
...
def test_reduce_with_bin_op(vector[i32] v, int init):
    """
...
# def test_reduce_with_execpolicy(vector[i32] v, int init):
#     """
...
def test_reduce_with_bin_op_and_execpolicy(vector[i32] v, int init):
    """
...
def test_transform_reduce(vector[i32] v1, vector[i32] v2, int init):
    """
...
def test_transform_reduce_with_bin_red_op_and_bin_tran_op(vector[i32] v1, vector[i32] v2, int init):
    """
...
def test_transform_reduce_with_bin_op_and_unary_op(vector[i32] v1, vector[i32] v2, int init):
    """
...
# def test_transform_reduce_with_execpolicy(vector[i32] v1, vector[i32] v2, int init):
#     """
...
def test_transform_reduce_with_execpolicy_bin_red_op_and_bin_tran_op(vector[i32] v1, vector[i32] v2, int init):
    """
...
# def test_transform_reduce_with_execpolicy_bin_op_and_unary_op(vector[i32] v1, vector[i32] v2, int init):
#     """
...
def test_inclusive_scan_with_bin_op_and_init(vector[i32] v, int init):
    """
...
# def test_inclusive_scan_with_execpolicy_bin_op_and_init(vector[i32] v, int init):
#     """
...
def test_transform_inclusive_scan_with_init(vector[i32] v, int init):
    """
...
def test_transform_inclusive_scan_with_execpolicy_and_init(vector[i32] v, int init):
    """
    Test transform inclusive_scan with an initial value
...
def test_exclusive_scan(vector[i32] v, int init):
    """
    Test exclusive_scan
...
# def test_exclusive_scan_with_execpolicy(vector[i32] v, int init):
#     """
...
def test_exclusive_scan_with_bin_op(vector[i32] v, int init):
    """
...
def test_exclusive_scan_with_execpolicy_and_bin_op(vector[i32] v, int init):
    """
...
def test_transform_exclusive_scan_with_execpolicy(vector[i32] v, int init):
    """
