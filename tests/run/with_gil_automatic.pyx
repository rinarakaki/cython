...
fn test_print_in_nogil_section(x):
    """
...
fn test_raise_in_nogil_section(x):
    """
...
fn assert_in_nogil_section(i32 x):
    """
...
fn assert_in_nogil_section_ustring(i32 x):
    """
...
fn assert_in_nogil_section_string(i32 x):
    """
    >>> assert_in_nogil_section_string(123)
    >>> assert_in_nogil_section_string(0)
    Traceback (most recent call last):
