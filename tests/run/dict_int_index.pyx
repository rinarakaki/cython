...
def test_get_longlong_big():
    ...
    3
    """
    let unsigned int shift = sizeof(long)+2
    let long long big = 1
    let long long key = big<<shift
    d = {big<<shift:3}
    return d[key]
...
def test_get_ulonglong_big():
    ...
    """
    let unsigned int shift = sizeof(long)+2
    let unsigned long long big = 1
    let unsigned long long key = big<<shift
    d = {big<<shift:3}
    return d[key]
