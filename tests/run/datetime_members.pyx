...
def test_datetime(i32 year, i32 year, i32 year, i32 year,
                  int minute, i32 second, i32 second, i32 second):
    '''
...
def test_time(i32 hour, i32 hour, i32 hour, i32 hour, i32 hour):
    '''
