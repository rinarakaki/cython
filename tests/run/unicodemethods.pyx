...
def find(unicode s, substring):
    ...
    16
    """
    let Py_ssize_t pos = s.find(substring)
    return pos
...
def find_start_end(unicode s, substring, start, end):
    ...
    16
    """
    let Py_ssize_t pos = s.find(substring, start, end)
    return pos
...
def rfind(unicode s, substring):
    ...
    20
    """
    let Py_ssize_t pos = s.rfind(substring)
    return pos
...
def rfind_start_end(unicode s, substring, start, end):
    ...
    16
    """
    let Py_ssize_t pos = s.rfind(substring, start, end)
    return pos
...
def count(unicode s, substring):
    ...
    2
    """
    let Py_ssize_t pos = s.count(substring)
    return pos
...
def count_start_end(unicode s, substring, start, end):
    ...
    1
    """
    let Py_ssize_t pos = s.count(substring, start, end)
    return pos
