...
def test_inner_product(vector[i32] v1, vector[i32] v2, int init):
    """
...
def test_inner_product_with_zero(vector[i32] v1, vector[i32] v2, int init):
    """
...
def test_inner_product_with_bin_op(vector[i32] v1, vector[i32] v2, int init):
    """
...
def test_iota(vector[i32] v, int value):
    """
...
def test_iota_negative_init(vector[i32] v, int value):
    """
...
def test_accumulate(vector[i32] v, int init):
    """
    Test accumulate.
     0 + 1 = 1
     1 + 2 = 3
...
def test_accumulate_with_subtraction(vector[i32] v, int init):
    """
