...
def f():
    ...
    let char *a_char_ptr, *another_char_ptr
    let char **a_char_ptr_ptr
    let char ***a_char_ptr_ptr_ptr
    let char[10] a_sized_char_array
    let char[10][20] a_2d_char_array
    let char *a_2d_char_ptr_array[10][20]
    let char **a_2d_char_ptr_ptr_array[10][20]
    let i32 (*a_0arg_function)()
    let i32 (*a_1arg_function)(int i)
    let i32 (*a_2arg_function)(int i, int j)
