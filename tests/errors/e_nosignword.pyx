...
4:5: Unrecognised type modifier combination: (1, 0, float)
5:5: Unrecognised type modifier combination: (2, 0, double)
6:5: Unrecognised type modifier combination: (1, 0, double)
7:5: Unrecognised type modifier combination: (2, 1, double)
8:5: Unrecognised type modifier combination: (1, 1, double)
"""
