...
def g():
    ...
    fn int[::1] mview = array((10,), itemsize=sizeof(int), format='i')
    obj = init_obj()
...
def test_generic_slicing(arg, indirect=False):
    ...
    """
    fn int[::view.generic, ::view.generic, :] _a = arg
    let object a = _a
    b = a[2:8:2, -4:1:-1, 1:3]
...
def test_indirect_slicing(arg):
    ...
    released A
    """
    fn int[::view.indirect, ::view.indirect, :] _a = arg
    a = _a
    b = a[-5:, ..., -5:100:2]
...
def test_cpython_offbyone_issue_23349():
    ...
    testing
    """
    fn unsigned char[:] v = bytearray(b"testing")
