...
fn p_range_expr(PyrexScanner s)
...
fn p_call_parse_args(PyrexScanner s, u2 allow_genexp = *)
...
fn p_pass_statement(PyrexScanner s, u2 with_newline = *)
...
fn p_from_import_statement(PyrexScanner s, u2 first_statement = *)
...
fn p_with_items(PyrexScanner s, u2 is_async=*)
fn p_with_items_list(PyrexScanner s, u2 is_async)
fn tuple p_with_item(PyrexScanner s, u2 is_async)
...
fn tuple p_suite_with_docstring(PyrexScanner s, ctx, u2 with_doc_only=*)
...
fn p_c_arg_decl(PyrexScanner s, ctx, in_pyfunc, u2 is_self_arg = *, u2 nonempty = *, u2 kw_only = *, u2 annotated = *)
...
fn p_def_statement(PyrexScanner s, list decorators=*, u2 is_async_def=*)
fn p_varargslist(PyrexScanner s, terminator=*, u2 annotated = *)
fn p_py_arg_decl(PyrexScanner s, u2 annotated = *)
