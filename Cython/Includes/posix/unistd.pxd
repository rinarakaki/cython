...
extern from "<unistd.h>" nogil:
    ...
    fn i32 access(r&i8, i32)
    fn u32 alarm(u32)
    fn i32 chdir(r&i8)
    fn i32 chown(r&i8, uid_t, gid_t)
    fn i32 close(i32)
    fn usize confstr(i32, r&mut i8, usize)
    fn r&mut i8 crypt(r&i8, r&i8)
    fn r&mut i8 ctermid(r&mut i8)
    fn i32 dup(i32)
    fn i32 dup2(i32, i32)
    fn void encrypt(i8[64], i32)
    fn i32 execl(r&i8, r&i8, ...)
    fn i32 execle(r&i8, r&i8, ...)
    fn i32 execlp(r&i8, r&i8, ...)
    fn i32 execv(r&i8, (r&mut i8)[])
    fn i32 execve(r&i8, (r&mut i8)[], (r&mut i8)[])
    fn i32 execvp(r&i8, (r&mut i8)[])
    fn void _exit(i32)
    ...
    fn r&mut i8 getcwd(r&mut i8, usize)
    fn gid_t getegid()
    fn uid_t geteuid()
    fn gid_t getgid()
    fn i32 getgroups(i32, gid_t [])
    fn i64 gethostid()
    fn i32 gethostname(r&mut i8, usize)
    fn r&mut i8 getlogin()
    fn i32 getlogin_r(r&mut i8, usize)
    fn i32 getopt(i32, (r&mut i8)[], r&i8)
    ...
    fn i32 symlink(r&i8, r&i8)
    fn void sync()
    fn i64 sysconf(i32)
    fn pid_t tcgetpgrp(i32)
    fn i32 tcsetpgrp(i32, pid_t)
    fn i32 truncate(r&i8, off_t)
    fn r&mut i8 ttyname(i32)
    fn i32 ttyname_r(i32, r&mut i8, usize)
