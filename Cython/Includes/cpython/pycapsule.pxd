...
extern from "Python.h":
    ...
    fn object PyCapsule_New(void* pointer, &char name,
    ...
    fn void* PyCapsule_GetPointer(object capsule, &char name) except? NULL
    ...
    fn &char PyCapsule_GetName(object capsule) except? NULL
    ...
    fn u2 PyCapsule_IsValid(object capsule, &char name)
    ...
    fn i32 PyCapsule_SetName(object capsule, &char name) except -1
    ...
    fn void* PyCapsule_Import(&char name, i32 no_block) except? NULL
