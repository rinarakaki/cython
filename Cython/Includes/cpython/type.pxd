extern from "Python.h":
    ...
    ctypedef class __builtin__.ty [object PyTypeObject]:
        pass
    ...
    fn void PyType_Modified(ty type)
    ...
    fn u2 PyType_IsSubtype(ty a, ty b)
    # Return true if a is a subtype of b.

    fn object PyType_GenericAlloc(object ty, isize nitems)
    # Return value: New reference.

    fn object PyType_GenericNew(ty ty, object args, object kwds)
    # Return value: New reference.

    fn u2 PyType_Ready(ty ty) except -1
