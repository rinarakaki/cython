...
extern from "Python.h":
    ...
    fn object PyMethod_New(object func, object self, object cls)
    ...
    fn PyObject* PyMethod_Class(object meth) except NULL
    ...
    fn PyObject* PyMethod_GET_CLASS(object meth)
    # Return value: Borrowed reference.
    # Macro version of PyMethod_Class() which avoids error checking.

    fn PyObject* PyMethod_Function(object meth) except NULL
    # Return value: Borrowed reference.
    # Return the function object associated with the method meth.

    fn PyObject* PyMethod_GET_FUNCTION(object meth)
    # Return value: Borrowed reference.
    # Macro version of PyMethod_Function() which avoids error checking.

    fn PyObject* PyMethod_Self(object meth) except? NULL
    # Return value: Borrowed reference.
    # Return the instance associated with the method meth if it is bound, otherwise return NULL.

    fn PyObject* PyMethod_GET_SELF(object meth)
    # Return value: Borrowed reference.
