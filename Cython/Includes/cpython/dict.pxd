...
extern from "Python.h":
    ...
    fn i32 PyDict_SetItemString(object p, &char key, object val) except -1
    ...
    fn i32 PyDict_DelItemString(object p, &char key) except -1
    ...
    fn PyObject* PyDict_GetItemString(object p, &char key)
    # Return value: Borrowed reference.
