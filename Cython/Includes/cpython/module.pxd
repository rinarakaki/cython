...
extern from "Python.h":
    ...
    # ###################################################################
    fn object PyImport_ImportModule(r&i8 name)
    ...
    fn object PyImport_ImportModuleEx(r&i8 name, object globals, object locals, object fromlist)
    # Return value: New reference.
    ...
    fn object PyImport_ImportModuleLevel(r&i8 name, object globals, object locals, object fromlist, i32 level)
    # Return value: New reference.
    ...
    fn PyObject* PyImport_AddModule(r&i8 name) except NULL
    ...
    fn object PyImport_ExecCodeModule(r&i8 name, object co)
    # Return value: New reference.
    ...
    fn i32 PyImport_ImportFrozenModule(r&i8 name) except -1
    ...
    fn object PyModule_New(r&i8 name)
    # Return value: New reference.
    ...
    fn r&i8 PyModule_GetName(object module) except NULL
    ...
    fn r&i8 PyModule_GetFilename(object module) except NULL
    # Similar to PyModule_GetFilenameObject() but return the filename encoded
    # to ‘utf-8’.

    fn i32 PyModule_AddObject(object module, r&i8 name, object value) except -1
    ...
    fn i32 PyModule_AddIntConstant(object module, r&i8 name, i64 value) except -1
    # Add an integer constant to module as name. This convenience
    # function can be used from the module's initialization
    # function. Return -1 on error, 0 on success.

    fn i32 PyModule_AddStringConstant(object module, r&i8 name, r&i8 value) except -1
