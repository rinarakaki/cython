...
extern from "Python.h":
    ...
    # ###################################################################
    fn object PyImport_ImportModule(&char name)
    ...
    fn object PyImport_ImportModuleEx(&char name, object globals, object locals, object fromlist)
    # Return value: New reference.
    ...
    fn PyObject* PyImport_AddModule(&char name) except NULL
    ...
    fn object PyModule_New(&char name)
    # Return value: New reference.
    ...
    fn i32 PyModule_AddObject(object module, &char name, object value) except -1
    ...
    fn i32 PyModule_AddIntConstant(object module, &char name, i64 value) except -1
    # Add an integer constant to module as name. This convenience
    # function can be used from the module's initialization
    # function. Return -1 on error, 0 on success.

    fn i32 PyModule_AddStringConstant(object module, &char name, &char value) except -1
