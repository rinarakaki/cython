...
extern from "Python.h":
    ...
    fn object PyFile_FromFd(i32 fd, &char name, &char mode, i32 buffering,
                            &char encoding, &char errors, &char newline, i32 closefd)
    ...
    fn i32 PyFile_WriteString(&char s, object p) except? -1
