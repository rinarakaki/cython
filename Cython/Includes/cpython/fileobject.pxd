...
extern from "Python.h":
    ...
    fn object PyFile_FromFd(i32 fd, r&char name, r&char mode, i32 buffering,
                            r&char encoding, r&char errors, r&char newline, i32 closefd)
    ...
    fn object PyFile_GetLine(object p, i32 n)
    # Return value: New reference.
    ...
    fn i32 PyFile_WriteObject(object obj, object p, i32 flags) except? -1
    ...
    fn i32 PyFile_WriteString(r&char s, object p) except? -1
