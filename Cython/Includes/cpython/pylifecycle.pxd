...
extern from "Python.h":
    ...
    fn i32 Py_SetStandardStreamEncoding(&char encoding, &char errors)
    ...
    fn i32 Py_FdIsInteractive(FILE*, &char)
    ...
    # In their own files
    fn &char Py_GetVersion()
    fn &char Py_GetPlatform()
    fn &char Py_GetCopyright()
    fn &char Py_GetCompiler()
    fn &char Py_GetBuildInfo()
    fn &char _Py_gitidentifier()
    fn &char _Py_gitversion()
