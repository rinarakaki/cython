...
extern from "Python.h":
    ...
    fn object PyFunction_New(object code, object globals)
    ...
    fn PyObject* PyFunction_GetCode(object op) except? NULL
    # Return value: Borrowed reference.
    # Return the code object associated with the function object op.

    fn PyObject* PyFunction_GetGlobals(object op) except? NULL
    # Return value: Borrowed reference.
    # Return the globals dictionary associated with the function object op.

    fn PyObject* PyFunction_GetModule(object op) except? NULL
    # Return value: Borrowed reference.
