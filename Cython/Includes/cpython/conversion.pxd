...
cdef extern from "Python.h":
    ...
    f64 PyOS_string_to_double(const char *s, char **endptr, PyObject *overflow_exception) except? -1.0
    ...
    char* PyOS_double_to_string(f64 val, char format_code, i32 precision, i32 flags, i32 *ptype) except NULL
    # Convert a double val to a string using supplied format_code, precision, and flags.

    i32 PyOS_stricmp(const char *s1, const char *s2)
