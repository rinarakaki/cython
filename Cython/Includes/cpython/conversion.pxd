...
extern from "Python.h":
    ...
    fn i32 PyOS_snprintf(&char str, usize size, &char format, ...)
    ...
    fn i32 PyOS_vsnprintf(&char str, usize size, &char format, va_list va)
    # Output not more than size bytes to str according to the format
    # string format and the variable argument list va. Unix man page vsnprintf(2).

    fn f64 PyOS_string_to_double(&char s, &char* endptr, PyObject* overflow_exception) except? -1.0
