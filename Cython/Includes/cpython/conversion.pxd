...
extern from "Python.h":
    ...
    fn f64 PyOS_string_to_double(r&i8 s, char** endptr, r&PyObject overflow_exception) except? -1.0
    ...
    fn r&i8 PyOS_double_to_string(f64 val, char format_code, i32 precision, i32 flags, i32* ptype) except NULL
