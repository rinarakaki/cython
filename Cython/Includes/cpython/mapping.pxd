extern from "Python.h":
    ...
    fn i32 PyMapping_DelItemString(object o, r&char key) except -1
    ...
    fn u2 PyMapping_HasKeyString(object o, r&char key)
    ...
    fn object PyMapping_GetItemString(object o, r&char key)
    # Return value: New reference.
    # Return element of o corresponding to the object key or NULL on
    # failure. This is the equivalent of the Python expression
    # "o[key]".

    fn i32 PyMapping_SetItemString(object o, r&char key, object v) except -1
