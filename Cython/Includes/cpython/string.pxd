...
extern from "Python.h":
    ...
    fn object PyString_FromString(r&char v)
    ...
    fn object PyString_FromStringAndSize(r&char v, isize len)
    # Return value: New reference.
    ...
    fn object PyString_FromFormat(r&char format, ...)
    # Return value: New reference.
    ...
    # %s     r&char     A null-terminated C character array.
    ...
    fn object PyString_FromFormatV(r&char format, va_list vargs)
    # Return value: New reference.
    # Identical to PyString_FromFormat() except that it takes exactly two arguments.

    fn isize PyString_Size(object string) except -1
    # Return the length of the string in string object string.

    fn isize PyString_GET_SIZE(object string)
    # Macro form of PyString_Size() but without error checking.

    fn r&char PyString_AsString(object string) except NULL
    ...
    fn r&char PyString_AS_STRING(object string)
    # Macro form of PyString_AsString() but without error
    # checking. Only string objects are supported; no Unicode objects
    # should be passed.

    fn i32 PyString_AsStringAndSize(object obj, r&char* buffer, isize* length) except -1
    ...
    fn object PyString_Format(object format, object args)
    ...
    fn object PyString_InternFromString(r&char v)
    # Return value: New reference.
    ...
    fn object PyString_Decode(r&char s, isize size, r&char encoding, r&char errors)
    #  Return value: New reference.
    ...
    fn object PyString_AsDecodedObject(object str, r&char encoding, r&char errors)
    # Return value: New reference.
    ...
    fn object PyString_AsEncodedObject(object str, r&char encoding, r&char errors)
    # Return value: New reference.
