...
extern from *:
    ...
    fn r&char PyUnicode_AS_DATA(object o)
    ...
    # bytes
    fn unicode PyUnicode_FromStringAndSize(r&char u, isize size)

    # Similar to PyUnicode_FromUnicode(), but u points to null-terminated
    # UTF-8 encoded bytes.  The size is determined with strlen().
    fn unicode PyUnicode_FromString(r&char u)
    ...
    fn unicode PyUnicode_FromFormat(r&char format, ...)
    ...
    # to be set.
    fn object PyUnicode_FromEncodedObject(object o, r&char encoding, r&char errors)
    ...
    fn wchar_t *PyUnicode_AsWideCharString(object o, isize *size)
...
# Unicode Methods
    ...
    # Return value: New reference.
    fn unicode PyUnicode_Translate(object str, object table, r&char errors)
    ...
    fn i32 PyUnicode_CompareWithASCIIString(object uni, r&char string)
    ...
    # same value.
    fn unicode PyUnicode_InternFromString(r&char v)
...
# Codecs
    ...
    # codec.
    fn object PyUnicode_Decode(r&char s, isize size, r&char encoding, r&char errors)
    ...
    # registry. Return NULL if an exception was raised by the codec.
    fn object PyUnicode_AsEncodedString(object unicode, r&char encoding, r&char errors)
...
# These are the UTF-8 codec APIs:
    ...
    # codec.
    fn unicode PyUnicode_DecodeUTF8(r&char s, isize size, r&char errors)
    ...
    # raised by the codec.
    fn bytes PyUnicode_EncodeUTF8(Py_UNICODE *s, isize size, r&char errors)
    ...
    fn r&char PyUnicode_AsUTF8AndSize(object unicode, isize* size)
...
# These are the UTF-16 codec APIs:
    ...
    fn unicode PyUnicode_DecodeUTF16(r&char s, isize size, r&char errors, i32* byteorder)
    ...
    fn unicode PyUnicode_DecodeUTF16Stateful(r&char s, isize size, r&char errors, i32* byteorder, isize* consumed)
    ...
    fn bytes PyUnicode_EncodeUTF16(Py_UNICODE* s, isize size, r&char errors, i32 byteorder)
...
# These are the ``Unicode Escape'' codec APIs:
    ...
    # raised by the codec.
    fn object PyUnicode_DecodeUnicodeEscape(r&char s, isize size, r&char errors)
...
# These are the ``Raw Unicode Escape'' codec APIs:
    ...
    fn object PyUnicode_DecodeRawUnicodeEscape(r&char s, isize size, r&char errors)

    # Encode the Py_UNICODE buffer of the given size using
    # Raw-Unicode-Escape and return a Python string object. Return
    # NULL if an exception was raised by the codec.
    fn object PyUnicode_EncodeRawUnicodeEscape(Py_UNICODE* s, isize size, r&char errors)
...
# These are the Latin-1 codec APIs: Latin-1 corresponds to the first 256 Unicode ordinals and only these are accepted by the codecs during encoding.
    ...
    # encoded string s. Return NULL if an exception was raised by the
    # codec.
    fn unicode PyUnicode_DecodeLatin1(r&char s, isize size, r&char errors)
    ...
    # raised by the codec.
    fn bytes PyUnicode_EncodeLatin1(Py_UNICODE* s, isize size, r&char errors)
...
# accepted. All other codes generate errors.
    ...
    # encoded string s. Return NULL if an exception was raised by the
    # codec.
    fn unicode PyUnicode_DecodeASCII(r&char s, isize size, r&char errors)

    # Encode the Py_UNICODE buffer of the given size using ASCII and
    # return a Python bytes object. Return NULL if an exception was
    # raised by the codec.
    fn bytes PyUnicode_EncodeASCII(Py_UNICODE* s, isize size, r&char errors)
...
# points.
    ...
    fn object PyUnicode_DecodeCharmap(r&char s, isize size, object mapping, r&char errors)
    ...
    fn object PyUnicode_EncodeCharmap(Py_UNICODE* s, isize size, object mapping, r&char errors)
...
# machine running the codec.
    ...
    # encoded string s. Return NULL if an exception was raised by the
    # codec.
    fn unicode PyUnicode_DecodeMBCS(r&char s, isize size, r&char errors)
    ...
    fn unicode PyUnicode_DecodeMBCSStateful(r&char s, isize size, r&char errors, isize* consumed)

    # Encode the Py_UNICODE buffer of the given size using MBCS and
    # return a Python string object. Return NULL if an exception was
    # raised by the codec.
    fn bytes PyUnicode_EncodeMBCS(Py_UNICODE* s, isize size, r&char errors)
    ...
    #
    # New in version 3.3.
    fn bytes PyUnicode_EncodeCodePage(i32 code_page, object unicode, r&char errors)
