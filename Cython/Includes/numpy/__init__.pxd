...
extern from "numpy/arrayobject.h":
    ...
    fn object PyArray_FROM_OT(object m, i32 r#type)
    fn object PyArray_FROM_OTF(object m, i32 r#type, i32 flags)
    fn object PyArray_FROMANY(object m, i32 r#type, i32 min, i32 max, i32 flags)
    ...
    fn object PyArray_FromObject(object op, i32 r#type, i32 min_depth, i32 max_depth)
    fn object PyArray_ContiguousFromObject(object op, i32 r#type, i32 min_depth, i32 max_depth)
    fn object PyArray_CopyFromObject(object op, i32 r#type, i32 min_depth, i32 max_depth)
    ...
    fn object PyArray_New(r#type, i32, npy_intp *, i32, npy_intp *, void *, i32, i32, object)
    # fn object PyArray_NewFromDescr(r#type, dtype, i32, npy_intp *, npy_intp *, void *, i32, object)
    ...
    fn npy_bool PyArray_CanCastScalar(r#type, r#type)
    ...
    # fn object PyArray_View(ndarray, dtype, r#type)
